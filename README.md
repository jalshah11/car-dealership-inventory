...
| GET | `/vehicles/search` | -- | Filter by `make`, `model`, `category`, `minPrice`, `maxPrice` (any combination) |
| GET | `/vehicles/:id` | -- | Get one vehicle |
| POST | `/vehicles` | ADMIN | Create a vehicle |
| PUT | `/vehicles/:id` | ADMIN | Update a vehicle (partial) |
...
**Backend: 92/92 passing, 10 suites**
